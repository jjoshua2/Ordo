...
extern void relpriors_copy(const struct rel_prior_set* r,
                           struct rel_prior_set* s /*@out@*/);
extern void relpriors_show(const struct PLAYERS* plyrs,
                           const struct rel_prior_set* rps);
extern void relpriors_init(bool_t quietmode, const struct PLAYERS* plyrs,
                           const char* f_name,
...
extern bool_t relpriors_replicate(struct rel_prior_set* rps,
...
extern void priors_load(bool_t quietmode, const char* fpriors_name,
...
extern void priors_show(const struct PLAYERS* plyrs, struct prior* p,
                        player_t n);

extern bool_t has_a_prior(struct prior* pr, player_t j);

extern void anchor_j(player_t j, double x, struct RATINGS* rat /*@out@*/
                     ,
                     struct PLAYERS* plyrs /*@out@*/);

extern void init_manchors(bool_t quietmode, const char* fpins_name,
                          struct RATINGS* rat /*@out@*/
                          ,
                          struct PLAYERS* plyrs /*@out@*/);
