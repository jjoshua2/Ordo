...
double xpect(double a, double b, double beta) {
...
double draw_rate_fperf(double p, double d0) {
...
static double draw_rate_fperf_calc(double p, double d0) {
  //	double fi;
  double a, c;
  double ret;
...
static double draw_rate_fperf_iter(double p, double d0) {
  double fi, a, b, c, x, y, dy, newx;
...
void get_pWDL(double delta_rating /*delta rating*/, double* pw, double* pd,
              double* pl, double d0, double beta) {
