...
void randfast_init(uint32_t seed) { raninit(&Rndseries, seed); }

uint32_t randfast32(void) { return ranval(&Rndseries); }

//==========================================
#include "gauss.h"

static double rand_area(void) {
  uint32_t r;
  double rr;
  do {
    r = randfast32();
...
static double rand_gauss_normalized(void) {
...
double rand_gauss(double x, double s) {
