...
extern bool_t supporting_auxmem_init(player_t nplayers, struct prior** pPP,
                                     struct prior** pPP_store);

extern void supporting_auxmem_done(struct prior** pPP,
                                   struct prior** pPP_store);
...
extern bool_t priorlist_replicate(player_t nplayers, struct prior* PP,
                                  struct prior** pQQ);
